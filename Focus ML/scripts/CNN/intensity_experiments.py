...
FEATURE_NAME = 'flux'
TARGET_NAME = ['intensity1', 'intensity2', 'tilt0', 'tilt1', 'tilt2', 'angle0', 'angle1', 'angle2']
...
def exp(x_train, y_train, x_test, y_test, i, orig_test):
    ...
    with h5py.File(f'../cv/intensity/predict{i}.h5', 'w') as f:
...
if __name__ == "__main__":
    x_data, y_data = utils.load_data(FEATURE_NAME, TARGET_NAME, '../data/train_intensity.h5')
